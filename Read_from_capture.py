import pyshark
import time                                                                                                 # define file path
file_path = "2017-07-22-traffic-analysis-exercise.pcap"                                                                                                           # define capture object
capture = pyshark.FileCapture(file_path)              
print("reading from file: %s" % file_path)                                                                  for packet in capture:
    # adjusted output                                     try:
